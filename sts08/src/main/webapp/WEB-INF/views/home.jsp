...
<head>
	...
	<script type="text/javascript">
		...
		function pageIdx(){
			...
			var ele='<img alt="" src="imgs/b05.jpg" class="img-thumbnail"/><img alt="" src="imgs/b06.jpg" class="img-thumbnail"/>';
			$('#content').html(ele);
		}
		function pageIntro(){
			$('nav a').eq(1).parent().removeClass('active');
			...
			$('nav a').eq(3).parent().removeClass('active');
			var ele='<img alt="" src="imgs/b01.jpg" class="img-thumbnail"/><img alt="" src="imgs/b02.jpg" class="img-thumbnail"/>'
			$('#content').html(ele);
		}
