			...
			<div class="notice">
				...
				<div class="tab_each">
					...
					<ul id="notices" class="show_list open_list">
                        ...
                        <li><a href="https://www.goodchoice.kr/more/notice#notive_tab" id="notive_tab" class="list_que open"><p>[발표] 7월 4차 무료초대권 이벤트</p> <span>2019.07.22
                                    <!----></span></a> 
                        </li>
                            
                        <li>
							<a href="https://www.goodchoice.kr/more/notice#notive_tab" id="notive_tab" class="list_que">
								<p>{{row.nttitle}}</p>
								<span>{{row.ntreg2}}
